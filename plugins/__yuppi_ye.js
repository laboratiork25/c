//aggiunge le thumbnail per i messaggi con i comandi di successo, il nome e irrilevate, baste  che venga esportato con export default global.successo o simili;
...
global.phishy = {
    contextInfo: {
        ...
        externalAdReply: {
            title: 'PᏂ𝚒𝑠𝐡ⲩ ᶠᶸᶜᵏᵧₒᵤ!', // non lo so cosa fare, modofica tu il titolo o il body
            body: '𝙥𝙤𝙬𝙚𝙧𝙚𝙙 𝙗𝙮 Chatteunity',
            mediaType: 1,
...
export default global.successo;
